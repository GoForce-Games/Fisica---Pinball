...
// Load new texture from surface
// Surface is freed upon execution
SDL_Texture* const ModuleTextures::Load(SDL_Surface* surface)
{
	SDL_Texture* texture = nullptr;

	if (surface == nullptr) {
		LOG("Unable to load from NULL surface");
	}
	else {
